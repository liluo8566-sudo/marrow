...
- Reconciled blocks (alerts, tasks, affect, timeline) write md back to DB on refresh. Purge flow: clear dashboard block first → clear DB → refresh.
